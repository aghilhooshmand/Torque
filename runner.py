...
class TorqueRunner:
    ...
    def run_ast(
        ...
        Args:
            ...
            output_file: Path to output JSON file (default: "torque_results.json")
        ...
        Example:
            >>> from Torque_Mapper import TorqueMapper
            >>> from runner import TorqueRunner
            >>> 
            >>> mapper = TorqueMapper()
    ...
    def run_dsl(
        ...
        Args:
            ...
            metrics_json_file: Path to output JSON file for metrics (default: "torque_results.json")
            test_size: Proportion of data for testing (default: 0.3)
            cv_folds: Number of cross-validation folds (default: 5)
            random_state: Random seed for reproducibility (default: 42)
        ...
        if mapped_json_file is None:
            ...
            mapped_json_file = f"torque_mapped_{cmd_hash}.json"
...
Examples:
  ...
  # everything should be in the config file for reproducibility.
    ...
    metrics_output = output_config.get("metrics_json_file", "torque_results.json")
